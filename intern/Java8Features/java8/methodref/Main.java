	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			if(n==1) {
				...
				for(Contact c:ph.viewAllContacts()) {
				...
				Contact c=ph.viewContactGivenPhone(phnno);
					if(c!=null) {
				...
				System.out.println("Enter the Phone number to search remove:");
				long phnno=sc.nextLong();
				System.out.println("Do you want to remove the contact (Y/N):");
				char ch=sc.next().charAt(0);
				if(ch=='y'||ch=='y') {
					if(ph.removeContact(phnno)) {
