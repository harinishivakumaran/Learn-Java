...
//code here
		try (Connection con = DBConnectionManager.getInstance().getConnection()) {
			...
			while (resSet.next()) {
				...
				StudentAdmission stdAdmObj = new StudentAdmission(admissionId, studentCode, dateOfCounseling,
						departmentName, dateOfAdmission, preferCollegeHostel, firstGraduate, managerApproval,
						admissionFee, tuitionFee, hostelFee, totalCollegeFee, finalStatusOfAdmission);
