...
public class SkeletonValidator {
	public SkeletonValidator() {
		...
		validateMethodSignature("addStudentAdmissionDetails:boolean,getAllStudentAdmissionDetails:List",
		...
		validateMethodSignature("getConnection:Connection,getInstance:DBConnectionManager",
		...
		try {
			...
			LOG.log(Level.SEVERE,
					"There is an error in validating the " + "Class Name. Please manually verify that the "
							+ "Class name is same as skeletonbefore uploading");
		}
		return iscorrect;
	}
